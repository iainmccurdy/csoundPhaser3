class GameScene extends Phaser.Scene {
    ...
    create() 
    {    
        csound.inputMessage("i 10 0 -1"); // rain
        csound.inputMessage("i 60 0 -1"); // walking
        csound.inputMessage("i 31 0 -1"); // thunder reverb
    ...
    {
        csound.inputMessage("i 20 0 1"); // bells sound
    ...
    triggerLightning ()
    {
        csound.inputMessage("i 30 1 0.1"); // thunder sound
    ...
    triggerCannonBalls()
    {
        this.timedEvent2.reset({ delay: Phaser.Math.Between(100,2000), callback: this.triggerCannonBalls, callbackScope: this, repeat: 1});
        
        this.cannons.children.iterate(function (child) {
            csound.inputMessage("i 40 0 0.06"); // spit sound
            //  Give each cannon ball a slightly different bounce
    ...
    {
        csound.inputMessage("i 70 0 0.3");
        this.gameOver();
    }
    ...
    dropBomb()
    {
        csound.inputMessage("i 90 0 3"); // bomb explode
